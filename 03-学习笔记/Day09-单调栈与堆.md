...
1. 先完成本页 739 与 [[02-Wiki/题目详解/150-逆波兰表达式求值|150 逆波兰表达式求值]]，分清“栈保存待结算状态”和“栈保存表达式操作数”。
2. 再练 [[02-Wiki/题目详解/703-数据流中的第K大元素|703 数据流中的第 K 大元素]]、[[02-Wiki/题目详解/1046-最后一块石头的重量|1046 最后一块石头的重量]] 和本页 347，统一 Top K / 堆顶含义。
3. 最后处理 84、215、295、621、355：它们分别对应边界、快选、双堆、调度公式和数据结构设计，不能只靠背模板。
